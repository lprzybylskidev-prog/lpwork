...
/**
 * Represents the before rule framework component.
 */
final readonly class BeforeRule implements ValidationRule
{
    /**
     * Creates a new BeforeRule instance.
     */
    ...
    public function validate(string $field, mixed $value, array $input, array $parameters = []): ?ValidationMessage
    {
        ...
        return new ValidationMessage('validation.before', ['field' => $field, 'date' => $target]);
    }
}
