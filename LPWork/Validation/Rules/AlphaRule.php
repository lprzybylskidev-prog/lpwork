...
/**
 * Represents the alpha rule framework component.
 */
final readonly class AlphaRule implements ValidationRule
{
    /**
    ...
    public function validate(string $field, mixed $value, array $input, array $parameters = []): ?ValidationMessage
    {
        ...
        return new ValidationMessage('validation.alpha', ['field' => $field]);
    }
}
