...
/**
 * Represents the gt rule framework component.
 */
final readonly class GtRule implements ValidationRule
{
    /**
     * Creates a new GtRule instance.
     */
    ...
    public function validate(string $field, mixed $value, array $input, array $parameters = []): ?ValidationMessage
    {
        ...
        return $number !== null && $number > $minimum
            ? null
            : new ValidationMessage('validation.gt', ['field' => $field, 'value' => $minimum]);
    }
}
