...
/**
 * Represents the after rule framework component.
 */
final readonly class AfterRule implements ValidationRule
{
    /**
     * Creates a new AfterRule instance.
     */
    ...
    public function validate(string $field, mixed $value, array $input, array $parameters = []): ?ValidationMessage
    {
        ...
        return new ValidationMessage('validation.after', ['field' => $field, 'date' => $target]);
    }
}
