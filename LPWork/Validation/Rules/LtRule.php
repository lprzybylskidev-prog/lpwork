...
/**
 * Represents the lt rule framework component.
 */
final readonly class LtRule implements ValidationRule
{
    /**
     * Creates a new LtRule instance.
     */
    ...
    public function validate(string $field, mixed $value, array $input, array $parameters = []): ?ValidationMessage
    {
        ...
        return $number !== null && $number < $maximum
            ? null
            : new ValidationMessage('validation.lt', ['field' => $field, 'value' => $maximum]);
    }
}
