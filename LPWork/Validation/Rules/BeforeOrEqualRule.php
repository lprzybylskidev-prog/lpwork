...
/**
 * Represents the before or equal rule framework component.
 */
final readonly class BeforeOrEqualRule implements ValidationRule
{
    /**
     * Creates a new BeforeOrEqualRule instance.
     */
    ...
    public function validate(string $field, mixed $value, array $input, array $parameters = []): ?ValidationMessage
    {
        ...
        return new ValidationMessage('validation.before_or_equal', ['field' => $field, 'date' => $target]);
    }
}
