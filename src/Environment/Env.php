...
final class Env
{
    ...
    public function getInt(string $key, ?int $default = null): int
    {
        ...
        if (!\is_numeric($value)) {
            throw new EnvValueInvalidException(\sprintf('Environment key "%s" is not numeric.', $key));
        }
    ...
    public function getBool(string $key, ?bool $default = null): bool
    {
        ...
        throw new EnvValueInvalidException(\sprintf('Environment key "%s" is not boolean-convertible.', $key));
    }
